    ...
    <footer className='mt-[60px]'>
      ...
      />
                ...
                <div className='w-[290px]'>
                    ...
                    <p className='text-[#240E0099] font-medium mt-[20px]'><span className='text-[black]'>Manzil:</span> 100052, O'zbekiston Respublikasi, Toshkent shahri, Bodomzor yo‘li 1-tor ko‘chasi, 72</p>
