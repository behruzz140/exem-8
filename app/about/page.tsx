                ...
                <div>
                  ...
                  <div>
                    ...
                    <div className=' pl-[30px]'>
                      ...
                      <p className='text-[18px] '>2. Номер телефона, c которого вы зарегистрированы на Uzum Market, и номер телефона, который подключен к номеру карты для получения СМС-оповещений, должен быть один и тот же.</p>
                    ...
                    <h4 className='text-[24px] font-semibold mb-[10px] mt-[10px]'> Как оформить рассрочку?</h4>
                      ...
                      <p className='text-[18px] '>5. B способе оплаты выберите рассрочку на удобный период: 3, 6 или 12 месяцев, и нажмите «Заполнить анкету». Отмечаем, что при выборе рассрочки на 3 месяца сумма одной покупки не должна превышать 5 000 000 сум.</p>
                  </div>
                </div>
            }
            {
